package com.garbagecleaner.utils;

import android.content.Context;
import android.content.SharedPreferences;

import com.garbagecleaner.OtpCleanerApp;


public class SharedPrefUtils {
    private static final String SHARED_PREF_FILENAME = "otp_cleaner_preference";

    private static SharedPreferences getSharedPreference() {
        return OtpCleanerApp.getAppContext().getSharedPreferences(SHARED_PREF_FILENAME, Context.MODE_PRIVATE);
    }
